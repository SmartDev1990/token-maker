...
import LogoTransparent from "../../public/bitmap.png";
...
const Layout: React.FunctionComponent<Props> = ({children}) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center w-20 h-30 flex-shrink-0 mr-6">
          <Image src={LogoTransparent} className="text-red-200 w-15 h-15" alt="" />
        </div>
